...
<meta charset="utf-8">
<title><?php echo xlt("Block Chain Setup"); ?></title>
<meta name="viewport"
...
<body>
    ...
    <script>
(function() {
    var app = angular.module("careChainApp",['ngSanitize','summernote',"checklist-model"]);
    ...
    <ng ng-app="careChainApp">
    <div class="container" id='main' style="display: none">
        <div class='header logo'>
            <h2>
                <img style='width: 48px; height: 48px;' class='logo'
                    src='<?php echo $GLOBALS['images_static_relative']; ?>/menu-logo.png' />  <?php echo xlt('Blockchain Setup'); ?></h2>
        </div>
        <div >
            <h2>
                 <?php echo xlt('Enable Blockchain'); ?></h2>
        </div>
            ...
            <aside class="col-md-1"
                ...
                <ul class="nav nav-pills nav-stacked"
                    ...
                    <li class="pill bg-danger"><a
                        href="<?php echo $GLOBALS['web_root']?>/patient/patient/provider"
                        ng-show="!isPortal"><?php echo xlt('Exit Mail'); ?></a></li>
                    <li data-toggle="pill" class="bg-danger"><a href="javascript:;"
                        onclick='window.location.replace("<?php echo $GLOBALS['web_root']?>/patient/home.php")'
