...
$(document).ready(function(){
    ...
    $("#blockchainsetup").load("./get_blockchain.php", { 'embeddedScreen' : true  });
    ...
    $("#medicationlist").load("./get_medications.php", { 'embeddedScreen' : true  }, function() {
        $("#allergylist").load("./get_allergies.php", { 'embeddedScreen' : true  }, function() {
            $("#problemslist").load("./get_problems.php", { 'embeddedScreen' : true  }, function() {
                    $("#documents").load("./get_documents.php", { 'embeddedScreen' : true  }, function() {
                        $("#visits").load("./get_visits.php", { 'embeddedScreen' : true  }, function() {
                    });
                });
            });
        });
    ...
    $(".generateDoc_download").click( function() {
     ...
     function showProfileModal(){
         ...
         var params = {
                   ...
                   title: title,
                   useBin: false,
                    url: webRoot+'/patient/patientdata?pid='+cpid+'&user='+cuser
                };
        ...
        <div id="popwait" class="alert alert-warning" style="font-size:18px"><strong><?php echo xlt('Working!'); ?></strong> <?php echo xlt('Please wait...'); ?></div>
            <div class="row collapse" id="lists">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel panel-primary">
                        <header class="panel-heading"><?php echo xlt('Lab Results / Documents'); ?> </header>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-primary">
                            <header class="panel-heading"><?php echo xlt('Visit / Encounters'); ?>  </header>
                            <div id="visits" class="panel-body"></div>
                            <div class="panel-footer"></div>
                        </div><!-- /.panel -->
                    </div><!-- /.col -->
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="panel panel-primary collapse" id="blockchain">
                        <header class="panel-heading"><?php echo xlt('Blockchain Setup'); ?>  </header>	
						<div id="blockchainsetup" class="panel-body"></div>
...
?>// really should always be able to download!
        ...
        <!-- /.content -->
        <!--<div class="footer-main">Care Chain, 2016 All Rights Reserved and Recorded</div>-->
    </aside><!-- /.right-side -->
    </div><!-- ./wrapper -->
