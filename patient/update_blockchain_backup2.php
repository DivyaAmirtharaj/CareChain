...
if ($_POST['blockchain_action'] == "save") {
	
	sqlStatement("UPDATE patient_access_onsite SET blockchain_status = " . $_POST['form_status'] . " WHERE pid =" .  $_POST['form_pid']);
...
<form method='post' name='blockchainform' id='blockchainform' action='update_blockchain.php?eid=<?php echo $eid ?>'>
<input type="hidden" name="blockchain_action" id="blockchain_action" value="">
<!--   <input type='hidden' name='form_pid' id='form_pid' value='<?php echo $patientid ?>' /> -->
...
<table border='0' width='100%'>
 <tr>
  ...
  <td align="left" height="50">
   <input type="checkbox" id='blockchain_status' name='blockchain_status' value='checked'
...
function validate() {
  ...
  var blockchain_action = document.getElementById('blockchain_action');
  blockchain_action.value="save";
...
//  alert( f.form_pid.value );
//  alert( f.blockchain_status.checked );
  
//  f.submit();
  return false;
//  var f = document.getElementById('theaddform');
 // alert('Value='.f.blockchain_status.value );
