	 ...
	 *
		Modify Date ‐ 10/15/2017
		Modify By - Divya Amirtharaj for CareChain
        Description ‐ Customized for CareChain
		*/ 
	...
	<html>
	<head>
		<title><?php echo xlt('CareChain Patient Portal Login'); ?></title>
	...
	?>  <!-- Main logon -->
		...
		<img style="width:65%" src='<?php echo $GLOBALS['images_static_relative']; ?>/login-logo1.png'/>
		<form  class="form-inline text-center" action="get_patient_info.php" method="POST" onsubmit="return process()">
			<div class="row">
					<div class="col-sm-12 text-center">
						<fieldset>
							<legend class="bg-primary"><h3><?php echo xlt('CareChain Patient Portal'); ?></h3></legend>
							<div class="well">
							<div class="row">
									<div class="col-sm-12">
										<div class="form-group inline">
