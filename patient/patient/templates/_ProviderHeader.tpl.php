...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $GLOBALS['web_root']; ?>/patient/patient/styles/style.css?v=<?php echo $GLOBALS['v_js_includes']; ?>" rel="stylesheet" />
        ...
        <script type="text/javascript">
            ...
            $LAB.script("<?php echo $GLOBALS['assets_static_relative']; ?>/jquery-min-1-11-3/index.js")
                ...
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/signer.js?v=<?php echo $GLOBALS['v_js_includes']; ?>")
    ...
    <body>
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                    <div class="navbar-header"><a class="navbar-brand" href="<?php echo $GLOBALS['web_root']; ?>/patient/patient/provider"><?php echo xlt('Home'); ?></a>
