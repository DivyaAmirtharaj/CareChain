...
<div class='well'>
    <div class="row">
        <div class="col-sm-3 col-md-3">
            ...
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/patient/import_template_ui.php"><?php echo xlt('Manage Templates') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-th"></i><?php echo xlt('Audit Changes') ?>
            </h4>
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/patient/patient/onsiteactivityviews"><?php echo xlt('Review Audits') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-cogs"></i><?php echo xlt('Patient Mail') ?>
            </h4>
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/patient/messaging/messages.php"><?php echo xlt('Mail') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-cogs"></i><?php echo xlt('Patient Chat') ?>
            </h4>
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/patient/messaging/secure_chat.php"><?php echo xlt('Messaging') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
...
<img id="waitend"
    ...
    src="<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/loading.gif" />
</div>
<!-- /container -->
