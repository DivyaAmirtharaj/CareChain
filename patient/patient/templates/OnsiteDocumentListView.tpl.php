...
<head>
<meta charset="UTF-8">
<title><?php echo xlt('CareChain Portal'); ?> | <?php echo xlt('Documents'); ?></title>
...
<meta name="description" content="Developed By sjpadgett@gmail.com">
        ...
        <link href="<?php echo $GLOBALS['web_root']; ?>/patient/assets/css/style.css?v=<?php echo $GLOBALS['v_js_includes']; ?>" rel="stylesheet" />
        <link href="<?php echo $GLOBALS['assets_static_relative']; ?>/font-awesome-4-6-3/css/font-awesome.min.css" rel="stylesheet" />
        <link href="<?php echo $GLOBALS['web_root']; ?>/patient/sign/css/signer.css?v=<?php echo $GLOBALS['v_js_includes']; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/signpad.css?v=<?php echo $GLOBALS['v_js_includes']; ?>" rel="stylesheet">

        <script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/libs/LAB.min.js"></script>
        <script type="text/javascript">
            ...
            $LAB.script("<?php echo $GLOBALS['assets_static_relative']; ?>/jquery-min-1-11-3/index.js")
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/signpad.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait()
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/signer.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait()
                ...
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/app.js?v=<?php echo $GLOBALS['v_js_includes']; ?>")
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/model.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait()
                .script("<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/view.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait()

        </script>
    </head>

<script type="text/javascript">
    $LAB.script("<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/app/onsitedocuments.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait()
        .script("<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/app/onsiteportalactivities.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait(function(){
                ...
                <form name="signit" id="signit" class="sigPad">
                    ...
                    <div class="sig sigWrapper">
                        ...
                        <img id="loading"
                            ...
                            src="<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/loading.gif" /> <input type="hidden" id="output" name="output" class="output">
                    </div>
...
<img id="waitend"	style="display: none; position: absolute; top: 100px; left: 250px; width: 100px; height: 100px" src="<?php echo $GLOBALS['web_root']; ?>/patient/sign/assets/loading.gif" />
<!-- Modal -->
    <!-- modal edit dialog -->
