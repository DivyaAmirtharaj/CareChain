...
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/app.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/model.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/patient/patient/scripts/view.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
