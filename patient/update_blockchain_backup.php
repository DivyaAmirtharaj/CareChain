...
<table border='0' width='100%'>
 <tr>
  ...
  <td nowrap style='padding:0px 5px 5px 0'>
   <input class="form-control input-sm" type="checkbox" id='form_title' name='form_title' 
   value='<?php echo htmlspecialchars($row['pc_title'], ENT_QUOTES) ? htmlspecialchars(['pc_title'], ENT_QUOTES) : 'Office Visit'; ?>' readonly='readonly'/>
  </td>
  <td></td>
  <td width='1%' nowrap>
    <b><?php xl('Date', 'e'); ?>:</b>
