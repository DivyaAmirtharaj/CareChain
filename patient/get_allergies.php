 ...
 */
    ...
    $sql = "SELECT id, title, date_format(begdate,'%m/%d/%Y') as begdate,  date_format(enddate,'%m/%d/%Y') as enddate, referredby, id FROM lists WHERE pid = ? AND type = 'allergy' ORDER BY id desc";
