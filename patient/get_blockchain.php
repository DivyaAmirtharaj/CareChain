 ...
 */
 ...
 echo '<tr><td width="10%" nowrap>Enable Blockchain:</td><td><input type="checkbox" name="enableBlockchain" onclick="return false;" ';
 echo $row['blockchain_status']==0 ? '' : 'checked' . '></td></tr>'; 
 echo '<tr><td>Public Key: </td><td> <input type="text" name="blockchain_publickey" value='.$row['blockchain_publickey']. ' disabled="true" size="50"</td></tr>';
