...
<head>
<meta charset="UTF-8">
<title><?php echo xlt('CareChain Portal'); ?> | <?php echo xlt('Home'); ?></title>
<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
<meta name="description" content="Developed for Care Chain">
...
<body class="skin-blue fixed">
    <header class="header">
        <a href="home.php" class="logo"><img src='<?php echo $GLOBALS['images_static_relative']; ?>/carechain_logo_con.png'/></a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown messages-menu"><a href="#"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="<?php echo $GLOBALS['web_root']; ?>/patient/messaging/messages.php"><?php echo xlt('See All Messages'); ?></a></li>
                        </ul></li>
                    ...
                    <li class="dropdown user user-menu"><a href="#"
                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <li><a href="<?php echo $GLOBALS['web_root']; ?>/patient/messaging/messages.php"> <i class="fa fa-envelope-o fa-fw pull-right"></i>
                                    <span class="badge badge-danger pull-right"> <?php echo text($msgcnt); ?></span> <?php echo xlt('Messages'); ?></a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo $GLOBALS['web_root']; ?>/patient/messaging/secure_chat.php?fullscreen=true"> <i class="fa fa-user fa-fw pull-right"></i><?php echo xlt('Chat'); ?></a>
        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <ul class="nav  nav-pills nav-stacked" style='font-color:#fff;'><!-- css class was sidebar-menu -->
                    ...
                    <li data-toggle="pill"><a href="#blockchain" data-toggle="collapse"
                        data-parent="#panelgroup"> <i class="fa fa-puzzle-piece"></i> <span><?php echo xlt('Blockchain'); ?></span>
                    </a></li>
                    <li data-toggle="pill"><a href="#lists" data-toggle="collapse"
                        data-parent="#panelgroup"> <i class="fa fa-list"></i> <span><?php echo xlt('Medical Records'); ?></span>
                    </a></li>
                    <li><a href="<?php echo $GLOBALS['web_root']; ?>/patient/patient/onsitedocuments?pid=<?php echo attr($pid); ?>"> <i class="fa fa-gavel"></i> <span><?php echo xlt('Patient Documents'); ?></span>
                    </a></li>
