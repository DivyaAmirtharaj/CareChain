...
<html>
<head>
<title><?php echo xlt('CareChain Provider Portal'); ?></title>
...
<div id="mainBox" <?php echo $disp_mainBox ?>>
    ...
    <div class="body_top">
        <a href="http://www.open-emr.org" title="CareChain <?php echo xla("Website"); ?>" target="_blank"><img class="logo" alt="openEMR small logo" style="float: left; margin:3px 4px 0px 10px;width:20px;z-index:10000;" border="0" src="<?php echo $GLOBALS['images_static_relative']; ?>/menu-logo.png"></a>
