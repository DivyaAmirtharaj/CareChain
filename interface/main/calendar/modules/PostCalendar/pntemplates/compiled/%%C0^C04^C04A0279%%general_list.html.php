<?php /* Smarty version 2.6.30, created on 2018-01-08 18:29:34
         compiled from C:/xampp/htdocs/carechain/templates/prescription/general_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'headerShow', 'C:/xampp/htdocs/carechain/templates/prescription/general_list.html', 13, false),array('function', 'xl', 'C:/xampp/htdocs/carechain/templates/prescription/general_list.html', 110, false),array('modifier', 'escape', 'C:/xampp/htdocs/carechain/templates/prescription/general_list.html', 130, false),)), $this); ?>
<html>
<head>
...
" <?php if ($this->_tpl_vars['prescription']->ntx > 0): ?>checked="checked" <?php endif; ?> onClick="markTx(this,'NewRx-<?php echo ((is_array($_tmp=$this->_tpl_vars['prescription']->id)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
');" title=<?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Select to transmit')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
>
        <?php endif; ?>
        </td>
        <td align="center">
...
" type="checkbox" <?php if ($this->_tpl_vars['prescription']->active < 1): ?>disabled="disabled" <?php endif; ?> value="<?php echo ((is_array($_tmp=$this->_tpl_vars['prescription']->id)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" <?php if ($this->_tpl_vars['prescription']->ntx > 0): ?>checked="checked" <?php endif; ?> onClick="markTx(this,'RefillRx-<?php echo ((is_array($_tmp=$this->_tpl_vars['prescription']->id)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
');" title=<?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Select to transmit')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
>
        <?php endif; ?>
        </td>
