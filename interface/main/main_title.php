...
<?php if ($GLOBALS['tiny_logo_1'] || $GLOBALS['tiny_logo_2']) {
    ...
    <td align="center" style="width:<?php echo attr($width_column) ?>">
...
<td align="left">
    <table cellspacing="2" cellpadding="1" style="margin:0px 0px 0px 3px;">
...
<tr><td style="vertical-align:text-bottom;">
        ...
        <span><?php echo htmlspecialchars(xl('PATIENT'), ENT_QUOTES); ?></span></a>
    </td>
