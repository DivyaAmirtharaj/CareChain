...
$tinylogocode1 = "<img width=48; height=52; src='" . $GLOBALS['OE_SITE_WEBROOT'] . "/images/carechain_logo.png'>";
//$tinylogocode1 = "<img class='tinylogopng' src='" . $GLOBALS['OE_SITE_WEBROOT'] . "/images/carechain_logo.png'>";
