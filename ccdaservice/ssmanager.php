...
function service_shutdown($soft = 1)
{
    if (socket_status('localhost', '6661', 'status')) {
        ...
        flush();
        echo '<h3 style="position: absolute; top: 25%; left: 42%">'. xlt("Shutting Down Service ...") . '</h3><img style="position: absolute; top: 40%; left: 45%; width: 125px; height: 125px" src="../../patient/sign/assets/loading.gif" />';
        ob_flush();
        flush();
