...
CareChain Software makes it a priority to keep this piece of software updated with the most recent available security options,  so it will integrate easily into a HIPAA-compliant practice and will protect our customers with at least the official HIPAA regulations.
<em>The Practice:</em> 
...
The Practice set up their User accounts for the CareChain databases, so it requires Users to log in with a password. 
