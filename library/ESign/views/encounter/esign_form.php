...
<div id='esign-form-container'>
    <form id='esign-signature-form' method='post' action='<?php echo attr($this->form->action); ?>'>
        ...
        <div class="esign-signature-form-element">
              <label for='encrypt'><?php echo xlt('Encrypt?');?></label> 
...
<!--              <span id='esign-signature-form-prompt'><?php echo xlt("Checking the lock checkbox will prevent any futher edits on any forms in this encounter."); ?></span> -->
              <span id='esign-signature-form-prompt'><?php echo xlt("Signing will lock this encounter and save it to Blockchain.  No furter edits on any forms in this encounter."); ?></span> 
        </div>
<!--        
 ...
 -->       
        <div class="esign-signature-form-element">
              <input type="checkbox" id="lock" name="lock" checked="true" hidden="true"/>
        </div>
        ...
        <div class="esign-signature-form-element">
              <input type='submit' value='<?php echo xla('Cancel'); ?>' id='esign-back-button' /> 
              <input type='button' value='<?php echo xla('Sign and Save in Blockchain'); ?>' id='esign-sign-button-encounter' />
        </div>
